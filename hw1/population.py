...
NS = Namespace("https://mariiacinkova.github.io/ontology#")
NSR = Namespace("https://mariiacinkova.github.io/resources/")
...
def load_csv_file_as_object(file_path: str):
    ...
    with open(file_path, "r") as stream:
        ...
        for line in reader:
            if line[2] == 'DEM0004' and (line[5] == '100' or line[5] == '101'):
...
def create_observation(collector: Graph, dataset, resource, data):
    ...
    if data['vuzemi_cis'] == 100:
        collector.add((resource, NS.county, Literal(data["vuzemi_txt"], lang="cs")))
    else:
        collector.add((resource, NS.region, Literal(data["vuzemi_txt"], lang="cs")))
