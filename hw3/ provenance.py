...
person = URIRef("https://mariiachinkova.github.io/person")
software = URIRef("https://mariiachinkova.github.io/software")
usage = URIRef("https://mariiachinkova.github.io/usage")
association = URIRef("https://mariiachinkova.github.io/association")
custom_role = Namespace("https://mariiachinkova.github.io/roles/")

g.add((ds1, RDF.type, PROV.Entity))
g.add((ds2, RDF.type, PROV.Entity))

activity = URIRef("https://mariiachinkova.github.io/activity")
